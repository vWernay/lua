...
namespace glm {
  ...
  namespace detail {
    ...
    struct lglm_compute_to_string<Ray<L, T, Q>> {
      static GLM_FUNC_QUALIFIER int call(char *buff, size_t buff_len, const Ray<L, T, Q> &ray) {
        ...
        lglm_compute_to_string<vec<L, T, Q>>::call(pos, GLM_STRING_BUFFER, ray.pos);
        lglm_compute_to_string<vec<L, T, Q>>::call(dir, GLM_STRING_BUFFER, ray.dir);
